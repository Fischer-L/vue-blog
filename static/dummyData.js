...
const posts = [
  {
    ...
    body: `
      ...
      <img src='${ROOT_PATH}post_0_pic1.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."
           data-srcset-big="${ROOT_PATH}post_0_pic1.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_0_pic1.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_0_pic1.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_0_pic1.jpg 320w"
      ...
      <img src='${ROOT_PATH}post_0_pic2.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."  
           data-srcset-big="${ROOT_PATH}post_0_pic2.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_0_pic2.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_0_pic2.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_0_pic2.jpg 320w"
           data-sizes-xsmall="(min-width: 320px) 320px"
      />
      ...
      <img src='${ROOT_PATH}post_0_pic3.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."
           data-srcset-big="${ROOT_PATH}post_0_pic3.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_0_pic3.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_0_pic3.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_0_pic3.jpg 320w"
           data-sizes-xsmall="(min-width: 320px) 320px"
      />
  ...
  },
  {
    ...
    body: `
      ...
      <img src='${ROOT_PATH}post_1_pic1.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."
           data-srcset-big="${ROOT_PATH}post_1_pic1.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_1_pic1.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_1_pic1.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_1_pic1.jpg 320w"
           data-sizes-xsmall="(min-width: 320px) 320px"
      />
      ...
      <img src='${ROOT_PATH}post_1_pic2.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."
           data-srcset-big="${ROOT_PATH}post_1_pic2.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_1_pic2.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_1_pic2.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_1_pic2.jpg 320w"
           data-sizes-xsmall="(min-width: 320px) 320px"
      />
      ...
      <img src='${ROOT_PATH}post_1_pic3.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."
           data-srcset-big="${ROOT_PATH}post_1_pic3.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_1_pic3.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_1_pic3.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_1_pic3.jpg 320w"
           data-sizes-xsmall="(min-width: 320px) 320px"
      />
  ...
  },
  {
    ...
    body: `
      ...
      <img src='${ROOT_PATH}post_2_pic1.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."
           data-srcset-big="${ROOT_PATH}post_2_pic1.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_2_pic1.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_2_pic1.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_2_pic1.jpg 320w"
           data-sizes-xsmall="(min-width: 320px) 320px"
      />
      ...
      <img src='${ROOT_PATH}post_2_pic2.jpg'
           data-comments="All sizes uses the same image? Come on, this is local dummy test..."
           data-srcset-big="${ROOT_PATH}post_2_pic2.jpg 1024w"
           data-sizes-big="(min-width: 1024px) 1024px"
           data-srcset-mid="${ROOT_PATH}post_2_pic2.jpg 768w"
           data-sizes-mid="(min-width: 768px) 768px"
           data-srcset-small="${ROOT_PATH}post_2_pic2.jpg 414w"
           data-sizes-small="(min-width: 414px) 414px"
           data-srcset-xsmall="${ROOT_PATH}post_2_pic2.jpg 320w"
           data-sizes-xsmall="(min-width: 320px) 320px"
      />
